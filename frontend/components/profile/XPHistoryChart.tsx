          ...
          >
            <div className="w-full relative flex items-end justify-center h-full">
              ...
              <div className="w-full max-w-[32px] relative">
                <div className="w-full bg-gray-500/20 dark:bg-white/5 rounded-t-sm h-36" />
                {/* Actual bar */}
                {item.xp > 0 && (
                  <div
            ...
            <span
              className={`text-[10px] font-medium uppercase ${isToday ? "text-purple-400" : "text-black dark:text-gray-500"}`}
            >
              {item.day}
            </span>
          </div>
