...
export default function ProfileHeader() {
  ...
  const joinDate = new Date(displayUser.created_at).toLocaleDateString(
    "en-US",
    {
      month: "long",
      year: "numeric",
  ...
  const bio =
    (displayUser as typeof displayUser & { bio?: string }).bio ||
      ...
      <div className="bg-quantum-glass-dark border border-white/10 rounded-xl overflow-hidden relative group">
        ...
        <div className="h-28 relative overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "repeating-linear-gradient(135deg, transparent, transparent 20px, rgba(255,255,255,0.03) 20px, rgba(255,255,255,0.03) 40px)",
            }}
          />
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="absolute -top-12 left-5">
              <div className="w-[88px] h-[88px] rounded-full bg-[#141622] p-[3px] shadow-xl">
                <div className="w-full h-full rounded-full bg-gray-700/30 flex items-center justify-center text-3xl font-bold text-gray-100 select-none">
                  {initials}
                </div>
              </div>
              {/* Online dot */}
              <div
                className="absolute bottom-1.5 right-1.5 w-4 h-4 bg-green-500 rounded-full border-[3px] border-[#141622] shadow"
                title="Online"
              />
            </div>
