...
\begin{itemize}
    \item \textbf{Conversion Latency:} The average time to convert a 50-gate circuit from Qiskit to OpenQASM 3.0 \cite{cross2021openqasm} was measured at \textbf{145ms}, well within the 1500ms target.
