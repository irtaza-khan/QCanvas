...
\section*{A. Package Installation Summary}

Both SDK packages are prepared as installable Python packages:
\begin{itemize}
    \item \textbf{QSim SDK:} \texttt{pip install fastqsim} \\
...
\toprule
\textbf{Algorithm} & \textbf{Max Qubits} & \textbf{Qiskit (ms)} & \textbf{Cirq (ms)} & \textbf{PennyLane (ms)} \\
\midrule
Bell State & 2 & 18.6 $\pm$ 0.4 & 8.3 $\pm$ 0.5 & 12.2 $\pm$ 0.3 \\
GHZ State & 8 & 21.9 $\pm$ 0.9 & 10.7 $\pm$ 0.4 & 38.0 $\pm$ 0.9 \\
Quantum Teleportation & 3 & 38.7 $\pm$ 0.9 & 15.6 $\pm$ 0.6 & 24.7 $\pm$ 0.6 \\
Deutsch--Jozsa & 8 & 7.0 $\pm$ 0.3 & 12.1 $\pm$ 1.3 & 106.3 $\pm$ 3.4 \\
Bernstein--Vazirani & 8 & 17.5 $\pm$ 0.6 & 13.0 $\pm$ 0.5 & 98.9 $\pm$ 2.5 \\
Grover's Algorithm & 6 & 9.6 $\pm$ 0.5 & 32.5 $\pm$ 1.9 & 184.2 $\pm$ 6.5 \\
QRNG & 8 & 12.8 $\pm$ 0.4 & 10.3 $\pm$ 0.2 & 37.0 $\pm$ 0.5 \\
VQE & 6 & 32.9 $\pm$ 3.9 & 13.8 $\pm$ 1.0 & 55.2 $\pm$ 2.9 \\
QAOA & 6 & 55.0 $\pm$ 3.2 & 19.1 $\pm$ 2.6 & 73.7 $\pm$ 7.2 \\
QML XOR Classifier & 4 & 47.9 $\pm$ 4.8 & 21.0 $\pm$ 1.6 & 73.9 $\pm$ 5.9 \\
Bit-Flip Code & 3 & 55.5 $\pm$ 27.0 & 14.0 $\pm$ 1.4 & 35.0 $\pm$ 4.1 \\
Phase-Flip Code & 3 & 64.8 $\pm$ 11.4 & 22.4 $\pm$ 5.3 & 54.7 $\pm$ 5.1 \\
\bottomrule
\end{tabular}%
}
\end{table}
